                ...
                <tbody>
                    ...
                    foreach ($pegawai as $pgi) :
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $pgi->NIP ?></td>
                            <td style="text-align: center;"><?php echo $pgi->Jabatan ?></td>
                            <td>
                                <span onclick="javascript: return confirm('Anda yakin hapus?')">
                                    <?php echo anchor('Pegawai/hapus/' .$pgi->NIP, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?>
                                </span>
                            </td>
                        </tr>
                    <?php
