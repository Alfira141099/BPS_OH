...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assetss/css/bootstrap.min.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assetss/css/style.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assetss/font-awesome/css/font-awesome.min.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assetss/plugins/fullcalendar/fullcalendar.css'; ?>">
      ...
      <div class="container-fluid">
          ...
          <center>
              ...
              <a href="https://fullcalendar.io/">
                <img id="logo" src="https://www.codeigniter.com/assetss/images/ci-logo-white.png" width="58" height="48">
            </a>
        </center>
    </div>
</nav>        
...
<script type="text/javascript" src="<?php echo base_url().'assetss/js/jquery.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'assetss/js/moment.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'assetss/js/bootstrap.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'assetss/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'assetss/plugins/fullcalendar/fullcalendar.js'; ?>"></script>      
